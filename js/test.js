...
function init() {
    ...
    requestAnimationFrame(tick);
		...
		composer = new THREE.EffectComposer( mRenderer );
		composer.addPass( new THREE.RenderPass( mScene, mCamera ) );
...
function initTHREE() {
    ...
    mCamera.position.set(280, 700, 3600);

    mScene = new THREE.Scene();

    var light;

    light = new THREE.PointLight(0xffffff, 40, 10000, 2);
    light.position.set(600, 400, 0);
    mScene.add(light);
}
...
function initGirl() {
  ...
  loader.load('models/meuf/buddha.json', function(geometry, materials) {
    ...
    girl.scale.set(10, 10, 10);
    girl.position.set(1470, -145, 2300);
    girl.rotation.x = -2.4;
    girl.rotation.y = -6;
    girl.rotation.z = -2;
    mScene.add(girl);
...
// loader.load('models/girl.js', function(geometry, materials) {
//   materials.forEach(function (material) {
//     material.skinning = true;
//   });
//
//   girl = new THREE.SkinnedMesh(
//     geometry,
//     new THREE.MeshFaceMaterial(materials)
//   );
//
//   girl.scale.set(150, 150, 150);
//   girl.position.set(1300, -1550, 2200);
//   girl.rotation.y = -3;
//   mScene.add(girl);
// });
}
...
function initParticleSystem() {
    ...
    for (i = 0, offset = 0; i < mParticleCount; i++) {
        ...
        y = THREE.Math.randFloat(200, 600);
    ...
    for (i = 0, offset = 0; i < mParticleCount; i++) {
        x = THREE.Math.randFloat(-1400, 1400);
        y = THREE.Math.randFloat(-1600, 2400);
    ...
    var materialnew = THREE.ParticleBasicMaterial({
      color: 0xFFFFFF,
      size: 20,
